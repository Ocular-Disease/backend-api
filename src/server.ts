...
export class App {
    ...
    private mapMiddleware() {
        ...
        this._app.use(
            cors({
                origin: ["http://localhost:3000", "https://front-end-react-nu.vercel.app", "https://front.gameshakes.com"],
                credentials: true,
            })
        );
        this._app.use(
    ...
    private mapRoutes() {
        ...
        this._app.use('/api/patients', patientRouter.router);
        this._app.use('/api/experts', expertRouter.router);
    }
